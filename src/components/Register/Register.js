...
<div>
	...
	<form onSubmit={handleSubmit}  action="" className="space-y-12 ng-untouched ng-pristine ng-valid">
		<div className="space-y-4">
			<div>
				<label htmlFor="name" className="block mb-2 text-sm">Your Full Name</label>
			...
			<div>
				<label htmlFor="name" className="block mb-2 text-sm">PhotoURL</label>
				<input type="text" name="photoURL" id="photoURL" placeholder="Photo URL" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100" />
			</div>
			<div>
		...
		<div className="space-y-2">
			...
			<p className="px-6 text-sm text-center text-gray-400">Already have an Account Login?
				<Link to={"/login"} href="#" className="hover:underline text-violet-400">Log in</Link>.
			</p>
		</div>
	</form>
</div>
