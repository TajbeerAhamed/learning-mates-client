...
.catch(error =>console.error(error))
    ...
    return (
        <div className="w-full mx-auto items-center max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-900 text-gray-100">
	...
	<div className="my-6 space-y-4">
		...
		<button onClick={githubLogIn} aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 focus:ring-violet-400">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
